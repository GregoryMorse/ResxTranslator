...
namespace ResxTranslator
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void ResetControlsState()
        {
            ...
            myOnlyTextCheckBox.Enabled = false;
        ...
        private void GetTotalResxFiles()
        {
            ...
            if (mySelectedFiles.Length > 0)
            {
                ...
                myOnlyTextCheckBox.Enabled = true;
            }
            else
            {
                mySelectAllResxFileCheckBox.Enabled = false;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            myLanguageCheckedBox.Items.AddRange(allLanguages.ToArray<Language>());
        ...
        {
            string msg = @"
    Developed by:   Ravikant Kumar. MS(SS), BE(CSE).
                        
    http://www.codeproject.com/Members/Kumar-Ravikant-India-Bangalore     
                        ";
            MessageBox.Show(msg, "Resx Translator");
        }
